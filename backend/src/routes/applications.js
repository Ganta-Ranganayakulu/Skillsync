...
// GET /api/applications/my/list  — job seeker's own applications
...
router.post('/:jobId', protect, jobSeekerOnly, async (req, res) => {
  try {
    ...
    // Auto-attach resume from user profile
...
// PUT /api/applications/:id/status  — update status (job provider)
